...
- **Corre y devuelve el formato completo.** Veinticuatro informes y ensayos guardados en `corridas/`. Los del caso
...
- **Distingue los tres casos, y en el orden correcto:**
  ...
  | Caso | Esperado | Agente v1.13 | Bruto | Estado |
  |------|---------:|------------:|------:|--------|
...
> **Sobre el caso excelente, el 10/9 — el día entero.** A la mañana una corrida limpia, en una
> sesión que nunca vio su `ESPERADO.md`, dio **65** en vez de los 89 de siempre. **Tenía razón:**
> el `system_prompt` del caso prohibía texto antes del array mientras el `user_prompt` pedía una
> línea de conteo. La contradicción la introdujimos nosotros el 31/8 y nunca la vimos, porque todas
> las corridas anteriores las hicimos sabiendo qué esperábamos de él.
>
> Corregido el caso, se volvió a correr **tres veces en limpio: 89, 89 y 89** — mismo bruto, mismos
> cinco niveles, sin banderas, y **sin poder fijar la temperatura**. El testigo vuelve a ser un
> testigo. Ver `corridas/2026-09-10_el-testigo-tenia-un-defecto.md` y
> `corridas/2026-09-10_el-testigo-volvio-a-su-banda.md`.
>
> Y **la vara separa**: tres trabajos incompletos dieron 25, 26 y 25; éste da 89 — tres veces y
> media.
...
rubrica.md        la rúbrica ejecutable (v1.13)
