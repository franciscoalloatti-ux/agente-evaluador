...
- **Corre y devuelve el formato completo.** Veintitres informes y ensayos guardados en `corridas/`. Los del caso
...
- **Distingue los tres casos, y en el orden correcto:**
  ...
  | Caso | Esperado | Agente v1.12 | Bruto | Estado |
  |------|---------:|------------:|------:|--------|
...
rubrica.md        la rúbrica ejecutable (v1.12)
